...
export function ExperienceItem({ date, title, company, city, description }: Props) {
  return (
    <li className="mb-10 ms-4">
      <div className="absolute w-3 h-3 bg-yellow-300 rounded-full mt-8 -start-1.5 border border-yellow-400" />
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <ul className="text-base font-normal text-gray-400 flex-[2] list-disc pl-4">
